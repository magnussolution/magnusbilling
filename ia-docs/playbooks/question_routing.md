...
## MBilling 8 / Asterisk 20 / PJSIP / WhatsApp Business

- Start overview: `ia-docs/domains/mbilling8_platform_changes.md`
- Installer evidence: `script/install.sh`
- PJSIP generation/runtime: `protected/components/AsteriskAccess.php`
