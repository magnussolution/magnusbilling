...
|---|---:|---:|---:|---|---|
| alarm | yes | yes | yes | pkg_alarm |  |
| api | yes | yes | yes | pkg_api | Which action the user will have execute |
| ata |  | yes |  |  |  |
| authentication |  | yes |  |  |  |
| backup | yes | yes |  |  |  |
...
| callSummaryMonthDid | yes | yes | yes | pkg_cdr_summary_month_did |  |
...
| campaign | yes | yes | yes | pkg_campaign | Available to massive calling. |
...
| campaignReport | yes | yes | yes | pkg_campaign_report |  |
| campaignRestrictPhone | yes | yes | yes | pkg_campaign_restrict_phone |  |
| clicToCall |  | yes |  |  |  |
...
| didHistory | yes | yes | yes | pkg_did_history |  |
| didUse | yes | yes | yes | pkg_did_use | DID Number |
| didww |  | yes |  |  |  |
| efi |  | yes |  |  |  |
| estados |  |  | yes | pkg_estados |  |
| extra |  | yes |  |  |  |
| firewall | yes | yes | yes | pkg_firewall | With this option marked on YES, the IP will be placed on the ip-blacklist list of fail2ban and will be blocked forever. |
...
| mercadoPago |  | yes |  |  |  |
| methodPay | yes | yes | yes | pkg_method_pay | Activate this if you want to be avaible for the clients. |
| methodpay |  | yes | yes | pkg_method_pay | Activate this if you want to be avaible for the clients. |
...
| placetoPay |  | yes |  |  |  |
| Plan | yes | yes | yes | pkg_plan | Select here the services that will be avaible to the users of this plan. |
| plan |  | yes | yes | pkg_plan | Select here the services that will be avaible to the users of this plan. |
| playAudio |  | yes |  |  |  |
...
| providerCNL | yes | yes | yes | pkg_provider_cnl |  |
...
| servicesUse | yes | yes | yes | pkg_services_use |  |
