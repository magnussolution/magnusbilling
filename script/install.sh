...
echo
echo '----------- Install Asterisk 23 ----------'
echo
sleep 1
cd /usr/src
rm -rf asterisk*
clear
wget https://downloads.asterisk.org/pub/telephony/asterisk/releases/asterisk-23.0.0.tar.gz
tar xzvf asterisk-23.0.0.tar.gz
rm -rf asterisk-23.0.0.tar.gz
cd asterisk-*
